...
FILE = "Rivas-Guia_basica_uso_inteligencia_artificial_generativa_2025.pdf"
...
def chunk_detective():
    ...
    rag_chain_1 = create_retrieval_chain(
        vector_store_1.as_retriever(), combine_docs_chain
    )
    rag_chain_2 = create_retrieval_chain(
        vector_store_2.as_retriever(), combine_docs_chain
    )
